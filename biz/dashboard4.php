...
function updateChart() {
    const datasets = generateRandomData(); // 차트에 표시될 데이터셋 생성
    const daysOfWeek = ['일', '월', '화', '수', '목', '금', '토']; // X축 레이블
    ...
    // Y축 최대값을 결정합니다. 여기서는 최댓값을 다음 10의 배수로 설정합니다.
