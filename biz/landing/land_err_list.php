...
if($member['mb_level'] >= 5) {
    ...
    select mb_no
         , mb_name
         , ifnull((select count(*) from gnp_crm_landing sub where a.mb_no = sub.land_empno and sub.use_yn = 'E' and insert_date2 = curdate() group by land_empno) ,0) as today_cnt
