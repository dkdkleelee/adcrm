...
if ($member['mb_deptno'] != "9") {
    if ($member['mb_level'] <= 6) {
        ...
        if ($member['mb_level'] == 4) {
            $add_cont = "and b.pg_mb_emp = {$member['mb_no']}";
        } else {
            $add_cont = "and b.pg_deptno = {$member['mb_deptno']}";
        }
    }
}
...
$sql_order = "order by land_idx desc";
...
<title>중복번호(<?php echo $_GET['tel'] ?>)</title>
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>중복번호 <b>(<?php echo $_GET['tel'] ?>)</b></h2>
					</div>
					<div class="col-sm-6">
			...
			<table class="table table-striped table-hover">
                ...
                <?php for ($i = 0; $row = sql_fetch_array($result); $i++) { ?>
					<tr>
						...
						<td><?php echo $row['land_idx'] ?></td>
                        <td><?php echo $row['name'] ?></td>
                        <td><?php echo $row['tel'] ?></td>
                        <td><?php echo $row['mb_emp_name'] ?></td>
                        <td><?php echo $row['inflow_path'] ?></td>
                        <td><?php echo $row['client_ip'] ?></td>
						<td><?php echo $row['use_yn'] ?></td>
						<td><?php echo view_dateformat($row['insert_date']) ?></td>
						<td><?php echo view_dateformat($row['insert_date']) ?></td>
