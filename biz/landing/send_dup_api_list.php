            ...
            <div class="col-12">
                <div class="card card-danger card-outline">
                    <div class="card-header">
                        <h3 class="card-title">API중복 DB(OUT) 조회(<?php echo number_format($total_count) ?>)</h3>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tbody>
                                                <?php for ($i = 0; $row = sql_fetch_array($result); $i++) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo G5_BIZ_URL ?>/landing/send_dup_api_list?sfl=ptn_idx&stx=<?php echo $row['land_ptn_idx'] ?>" target="_self">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo G5_BIZ_URL ?>/landing/send_dup_api_list?sfl=pg_uri&stx=<?php echo $row['pg_uri'] ?>" target="_self">
                                                                <?php echo $row['pg_uri'] ?>
                                                            </a>
