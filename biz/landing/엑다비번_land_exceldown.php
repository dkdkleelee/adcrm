...
//     // 세션이 없거나 true가 아니면 즉시 강제 종료
//     if (empty($_SESSION['ss_excel_download_passed']) || $_SESSION['ss_excel_download_passed'] !== true) {
//         alert("비정상적인 접근이거나 문자인증이 완료되지 않았습니다.");
//         exit;
//     }
//     // 엑셀 생성 시점에 1회용 세션을 파기하여, URL을 복사해서 다시 들어오는 것을 방지
