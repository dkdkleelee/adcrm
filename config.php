...
// WithUs 디버그바 설정입니다, 실제 서버운영시 false 로 설정해 주세요.
...
define('G5_BIZ_DIR',        'biz');

define('G5_ADMIN_DIR',      'adm');
define('G5_BBS_DIR',        'main');
...
if (isset($g5_path['document_root'])) {
    define('DOCUMENT_ROOT', $g5_path['document_root']);
...
// PATH 는 서버상에서의 절대경로
define('G5_BIZ_PATH',       G5_PATH.'/'.G5_BIZ_DIR);
