...
-------------------------------------------------------------------------
-- WithUs 자체 CRM SCHEME
-------------------------------------------------------------------------
CREATE TABLE `g5_crm_common` (
...
CREATE TABLE `g5_crm_partner` (
  ...
  `ptn_status` char(1) DEFAULT NULL,
  `ptn_startday` date DEFAULT NULL,
  `ptn_endday` date DEFAULT NULL,
  `ptn_dposday` date DEFAULT NULL,
  `ptn_budget` int(11) DEFAULT NULL COMMENT '0',
...
CREATE TABLE `g5_crm_partner_hist` (
...
CREATE TABLE `g5_crm_signup` (
  `sign_idx` int(11) NOT NULL AUTO_INCREMENT,
  `ptn_id` varchar(100) DEFAULT NULL,
  `ptn_pw` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  ...
  `sign_ip` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `insert_date` datetime DEFAULT NULL,
...
-- `des_ptn_idx` int(11) DEFAULT NULL,

CREATE TABLE `g5_crm_design` (
...
CREATE TABLE `g5_crm_page` (
  ...
  `pg_api_url` varchar(100) DEFAULT NULL,
  `pg_api_add_param` varchar(255) DEFAULT NULL,
  `pg_api_return_param` varchar(100) DEFAULT NULL,
  `pg_api_param_way` char(1) DEFAULT NULL,
  `pg_api_return_way` char(1) DEFAULT NULL,
...
CREATE TABLE `g5_crm_page_script` (
...
CREATE TABLE `g5_crm_landing` (
  `land_idx` int(11) NOT NULL AUTO_INCREMENT,
  `land_pg_idx` int(11) DEFAULT NULL,
  `land_ptn_idx` int(11) DEFAULT NULL,
  `land_used_data` char(1) DEFAULT NULL,
  ...
  `data3` varchar(30) DEFAULT NULL,
  `data4` varchar(30) DEFAULT NULL,
  `data5` varchar(30) DEFAULT NULL,
  `data6` varchar(30) DEFAULT NULL,
  ...
  PRIMARY KEY (`land_idx`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


CREATE TABLE `g5_crm_dbhist` (
...
CREATE TABLE `gnp_kwd_partner` (
  `kptn_idx` int(11) NOT NULL AUTO_INCREMENT,
  `kptn_mb_no` int(11) NOT NULL,
  `kptn_adtiser_id` varchar(100) DEFAULT NULL,
  `kptn_adtiser_nm` varchar(100) DEFAULT NULL,
  `kptn_platform` varchar(100) DEFAULT NULL,
  `kptn_custom_id` varchar(100) DEFAULT NULL,
  `kptn_acc_id` varchar(100) DEFAULT NULL,
  `kptn_acc_key` varchar(100) DEFAULT NULL,
  `use_yn` char(1) DEFAULT 'Y',
  `insert_date` datetime DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `insert_user` varchar(30) DEFAULT NULL,
  `update_user` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`kptn_idx`)
