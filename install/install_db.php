...
// WithUs 재설치에 체크하였거나 WithUs가 설치되어 있지 않다면
if ($g5_install || $is_install === false) {
    ...
    include_once('./withearth_alter.php');
}
...
if ($g5_install || $is_install === false) {
    ...
    //cf_new_skin & cf_search_skin & cf_connect_skin & cf_member_skin
    ...
    // 관리자2 회원가입
    // $sql = " 
    // INSERT INTO `{$table_prefix}member` (`mb_no`, `mb_id`, `mb_password`, `mb_gubun`, `mb_deptno`, `mb_ptnidx`, `mb_name`, `mb_nick`, `mb_nick_date`, `mb_email`, `mb_homepage`, `mb_level`, `mb_sex`, `mb_birth`, `mb_tel`, `mb_hp`, `mb_certify`, `mb_adult`, `mb_dupinfo`, `mb_zip1`, `mb_zip2`, `mb_addr1`, `mb_addr2`, `mb_addr3`, `mb_addr_jibeon`, `mb_signature`, `mb_recommend`, `mb_point`, `mb_today_login`, `mb_login_ip`, `mb_datetime`, `mb_ip`, `mb_leave_date`, `mb_intercept_date`, `mb_email_certify`, `mb_email_certify2`, `mb_memo`, `mb_lost_certify`, `mb_mailling`, `mb_sms`, `mb_open`, `mb_open_date`, `mb_profile`, `mb_memo_call`, `mb_memo_cnt`, `mb_scrap_cnt`, `mb_1`, `mb_2`, `mb_3`, `mb_4`, `mb_5`, `mb_6`, `mb_7`, `mb_8`, `mb_9`, `mb_10`, `login_fail_cnt`, `is_login`, `is_lock`, `confirm_date`) VALUES
    // (2, 'withus', 'sha256:12000:uaHBJZd/pkIT061FVXBvL+RJino5HqjM:1zL7CXaNuF0NpSl0apQo4SMCiLEi5Dq5', 'E', NULL, NULL, 'WithUs', 'WithUs', '2023-01-31', 'withus@daum.com', '', 9, '', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', 0, '2023-01-31 02:22:34', '127.0.0.1', '2023-01-31 02:16:25', '127.0.0.1', '', '', '2023-01-31 02:16:25', '', '', '', 1, 0, 1, '0000-00-00', '', '', 0, 0, '', '', '', '', '', '', '', '', '', '', 0, 'Y', 'N', NULL),
    // ";
    // sql_query($sql, true, $dblink);


    // CREATE WithUs_DEFAULT MENU
    //$currentip = gethostbyname(gethostname());
    // $sql = "
    // INSERT INTO gnp_menu (me_code,me_name,me_link,me_target,me_order,me_use,me_mobile_use,me_faicon,me_level) VALUES
	//  ('10','게시판','#','self',1,1,1,'fas fa-edit',NULL),
	//  ('1010','자유게시판','{$currentip}/bbs/board.php?bo_table=free','self',1,1,1,'',NULL),
	//  ('1020','공지사항','{$currentip}/bbs/board.php?bo_table=notice','self',1,1,1,'',NULL),
	//  ('20','랜딩','#','self',1,1,1,'fas fa-plane-arrival',NULL),
	//  ('2010','정상DB','#','self',1,1,1,'',3),
	//  ('2020','불량DB','#','self',1,1,1,'',3),
	//  ('30','페이지','{$currentip}/biz/page/page_list.php','self',1,1,1,'fas fa-save',4),
	//  ('40','디자인','{$currentip}/biz/design/design_list.php','self',1,1,1,'fas fa-palette',5),
	//  ('50','고객사','#','self',1,1,1,'fas fa-handshake',4),
	//  ('5010','고객사관리','{$currentip}/biz/partner/partner_list.php','self',1,1,1,'',4),
	//  ('5020','가입대기','{$currentip}/biz/partner/signup_list.php','self',1,1,1,'',4),
	//  ('60','인사관리','#','self',1,1,1,'fas fa-user',4),
	//  ('6010','부서관리','#','self',1,1,1,'',4),
	//  ('6020','임직원관리','#','self',1,1,1,'',4);
    // ";
    $sql = "
    INSERT INTO {$table_prefix}menu (me_id, me_code, me_name, me_link, me_target, me_order, me_use, me_mobile_use, me_faicon, me_level) VALUES
    (1, '10', '게시판', '#', 'self', 1, 1, 1, 'fas fa-edit', 2),
	(2, '1010', '자유게시판', 'http://admin.withusmk.co.kr/bbs/board.php?bo_table=free', 'self', 1, 1, 1, '', 2),
	(3, '1020', '공지사항', 'http://admin.withusmk.co.kr/bbs/board.php?bo_table=notice', 'self', 1, 1, 1, '', 2),
	(4, '20', '랜딩', '#', 'self', 1, 1, 1, 'fas fa-plane-arrival', 2),
	(5, '2010', '정상DB', 'http://admin.withusmk.co.kr/biz/landing/land_list.php', 'self', 1, 1, 1, '', 2),
	(6, '2020', '불량DB', 'http://admin.withusmk.co.kr/biz/landing/land_err_list.php', 'self', 1, 1, 1, '', 2),
	(7, '30', '페이지', '#', 'self', 1, 1, 1, 'fas fa-save', 4),
	(8, '3010', '페이지관리', 'http://admin.withusmk.co.kr/biz/page/page_list.php', 'self', 1, 1, 1, 'fas fa-save', 4),
	(9, '3020', '스크립트관리', 'http://admin.withusmk.co.kr/biz/page/page_script_list.php', 'self', 1, 1, 1, 'fas fa-save', 4),
	(10, '40', '디자인', 'http://admin.withusmk.co.kr/biz/design/design_list.php', 'self', 1, 1, 1, 'fas fa-palette', 4),
	(11, '50', '고객사', '#', 'self', 1, 1, 1, 'fas fa-handshake', 4),
	(12, '5010', '고객사관리', 'http://admin.withusmk.co.kr/biz/partner/partner_list.php', 'self', 1, 1, 1, '', 4),
	(13, '5020', '가입대기', 'http://admin.withusmk.co.kr/biz/partner/partner_signup_list.php', 'self', 1, 1, 1, '', 4),
	(14, '60', '인사관리', '#', 'self', 1, 1, 1, 'fas fa-user', 4),
	(15, '6010', '부서별직원', 'http://admin.withusmk.co.kr/biz/hr/hr_deptemp_list.php', 'self', 1, 1, 1, '', 4),
	(16, '6020', '가입대기', 'http://admin.withusmk.co.kr/biz/hr/hr_signup_list.php', 'self', 1, 1, 1, '', 4);
    ";
    sql_query($sql, true, $dblink);
    ...
    //공통코드 등록
    $sql = "
    INSERT INTO {$table_prefix}crm_common (comm_pcd,comm_pnm,comm_cd,comm_nm,comm_bigo,use_yn,deleteble,updateble,insert_date,update_date,insert_user,update_user) VALUES
	 (1,'광고문의',1,'인터넷서비스','adfafs','Y','Y','Y','2022-08-02 13:07:28.0','2022-08-02 17:45:56.0','',''),
	 (1,'광고문의',2,'반려동물용품','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',3,'의류/패션잡화','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',4,'뷰티','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',5,'식품/건강','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',6,'출산/유아동','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',7,'생활/주방','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',8,'가구/홈/데코','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',9,'스포츠/레져','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',10,'자동차','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',11,'전자기기','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',12,'도서/교육·취미','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',13,'문구/사무용품','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',14,'언론/미디어','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',15,'여행','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',16,'엔터테인먼트','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',17,'복권','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',18,'금융','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',19,'핸드폰','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',20,'분양','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',21,'병의원','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (1,'광고문의',22,'기타','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',1,'인터넷서비스','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',2,'반려동물용품','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',3,'의류/패션잡화','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',4,'뷰티','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',5,'식품/건강','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',6,'출산/유아동','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',7,'생활/주방','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',8,'가구/홈/데코','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',9,'스포츠/레져','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',10,'자동차','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',11,'전자기기','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',12,'도서/교육·취미','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',13,'문구/사무용품','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',14,'언론/미디어','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',15,'여행','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',16,'엔터테인먼트','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (2,'스토어',17,'기타','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (3,'DB',1,'식품/건강','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (3,'DB',2,'복권','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (3,'DB',3,'금융','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (3,'DB',4,'핸드폰','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (3,'DB',5,'분양','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (3,'DB',6,'병의원','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (3,'DB',7,'기타','','Y','N','N','2022-07-28 18:22:37.0','2022-08-02 14:47:34.0','',''),
	 (4,'기타',1,'기타','카테고리미선택','Y','Y','N','2022-08-02 13:12:45.0','2022-08-03 16:38:43.0','',''),
	 (5,'플랫폼',1,'미선택','','Y','Y','Y','2022-08-03 15:51:43.0','2022-08-23 13:48:26.0','',''),
	 (5,'플랫폼',2,'po','포핀','Y','Y','Y','2022-08-03 15:51:43.0','2022-08-08 17:19:02.0','',''),
	 (5,'플랫폼',3,'na','네이버','Y','Y','Y','2022-08-03 15:53:30.0','2022-08-08 17:19:02.0','',''),
	 (5,'플랫폼',4,'da','데이블','Y','Y','Y','2022-08-03 15:53:46.0','2022-08-08 17:19:02.0','',''),
	 (5,'플랫폼',5,'ta','타불라','Y','Y','Y','2022-08-03 15:53:59.0','2022-08-08 17:19:02.0','',''),
	 (5,'플랫폼',6,'re','문자','Y','Y','Y','2022-08-03 15:54:08.0','2022-08-08 17:19:02.0','',''),
	 (5,'플랫폼',7,'gk','카카오','Y','Y','Y','2022-08-03 15:55:59.0','2022-08-08 17:19:02.0','',''),
	 (5,'플랫폼',8,'dv','DV360','Y','Y','Y','2022-08-03 15:56:09.0','2022-08-08 17:19:02.0','',''),
	 (5,'플랫폼',9,'mm','MediaMath','Y','Y','Y','2022-08-03 15:56:19.0','2022-08-08 17:19:02.0','',''),
	 (6,'직급',1,'예비','','Y','Y','Y','2022-08-05 17:37:23.0','2022-08-18 16:36:16.0','',''),
	 (6,'직급',2,'디자이너','','Y','Y','Y','2022-08-05 17:37:23.0','2022-08-18 16:36:16.0','',''),
	 (6,'직급',3,'직원','','Y','Y','Y','2022-08-05 17:37:23.0','2022-08-18 16:36:16.0','',''),
	 (6,'직급',4,'팀원','','Y','Y','Y','2022-08-05 17:37:23.0','2022-08-18 16:36:16.0','',''),
	 (6,'직급',5,'팀장','','Y','Y','Y','2022-08-05 17:37:23.0','2022-08-18 16:36:16.0','',''),
	 (6,'직급',6,'부장','','Y','Y','Y','2022-08-05 17:37:23.0','2022-08-18 16:36:16.0','',''),
	 (6,'직급',7,'관리자','','Y','Y','Y','2022-08-05 17:37:23.0','2022-08-18 16:36:16.0','',''),
	 (7,'회의실',1,'고객미팅','','Y','Y','Y','2022-08-18 16:33:50.0','2022-08-18 16:36:16.0','',''),
	 (7,'회의실',2,'회의','','Y','Y','Y','2022-08-18 16:33:50.0','2022-08-18 16:36:16.0','',''),
	 (7,'회의실',3,'면접','','Y','Y','Y','2022-08-18 16:33:50.0','2022-08-18 16:36:16.0','',''),
	 (7,'회의실',4,'식사','','Y','Y','Y','2022-08-18 16:33:50.0','2022-08-18 16:36:16.0','',NULL);
    ";
...
fwrite($f, "\$g5['crm_common'] = G5_TABLE_PREFIX.'crm_common'; // CRM:코드관리\n");
fwrite($f, "\$g5['crm_depart'] = G5_TABLE_PREFIX.'crm_depart'; // CRM:부서관리\n");
fwrite($f, "\$g5['crm_partner'] = G5_TABLE_PREFIX.'crm_partner'; // CRM:파트너관리\n");
fwrite($f, "\$g5['crm_partner_hist'] = G5_TABLE_PREFIX.'crm_partner_hist'; // CRM:파트너히스토리\n");
fwrite($f, "\$g5['crm_signup'] = G5_TABLE_PREFIX.'crm_signup'; // CRM:파트너임시회원가입\n");
fwrite($f, "\$g5['crm_design'] = G5_TABLE_PREFIX.'crm_design'; // CRM:디자인관리\n");
fwrite($f, "\$g5['crm_page'] = G5_TABLE_PREFIX.'crm_page'; // CRM:페이지관리\n");
fwrite($f, "\$g5['crm_page_script'] = G5_TABLE_PREFIX.'crm_page_script'; // CRM:페이지스크립트관리\n");
fwrite($f, "\$g5['crm_landing'] = G5_TABLE_PREFIX.'crm_landing'; // CRM:랜딩페이지\n");
fwrite($f, "\$g5['crm_dbhist'] = G5_TABLE_PREFIX.'crm_dbhist'; // CRM:랜딩백업\n");

fwrite($f, "\$g5['crm_api_auth'] = G5_TABLE_PREFIX.'crm_api_auth'; // CRM:API인증\n");
fwrite($f, "\$g5['crm_api_resv'] = G5_TABLE_PREFIX.'crm_api_resv'; // CRM:API받음\n");
fwrite($f, "\$g5['crm_api_send'] = G5_TABLE_PREFIX.'crm_api_send'; // CRM:API예약\n");
...
<div class="ins_inner">
    ...
    <div class="inner_btn">
        <a href="../index.php">새로운 위드어스 ADMIN 이동</a>
    </div>
