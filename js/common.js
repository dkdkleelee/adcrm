...
//ctrl + enter 키 누를시 조회버튼 작동함
document.addEventListener('keydown', function(event) {
    if (event.ctrlKey && event.key === 'Enter') {
        var searchForm = document.querySelector('.form-inline.my-2.my-lg-0.ng-pristine.ng-valid');
        if (searchForm) {
            // 폼이 존재하는 경우, 폼 제출
            searchForm.submit();
        } else {
            alert('검색 폼을 찾을 수 없습니다.');
        }
...
//shift 누르고 체크박스 누르면 해당 row부터 상단 모든 체크박스 선택됨
