				...
				<div class="col-12">
					...
					<div class="card card-danger card-outline">
						<div class="card-header">
							<h3 class="card-title"><?php echo $board['bo_subject'] ?> 조회(<?php echo $total_count ?>)</h3>
						</div>
						...
						<form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" class="m-3">
							...
							<table class="table xs-full mb-0 table-bordered"> <!-- table-striped table-hover  -->
								<thead>
									<tr class="d-none d-md-table-row">
										...
										<?php if ($bo_table == "design_req") { ?>
											<th class="d-none d-md-table-cell" style="width: 6em;">디자이너</th>
											<th class="d-none d-md-table-cell" style="width: 9em;">요청일자</th>
											<th class="d-none d-md-table-cell" style="width: 9em;">시작일자</th>
											<th class="d-none d-md-table-cell" style="width: 9em;">마감일자</th>
											<th class="d-none d-md-table-cell" style="width: 6em;">작업상태</th>
										<?php } ?>
										<?php if($bo_table != "design_req") { ?>
								...
								<tbody>
									...
									?>
										<tr class="<?php if ($list[$i]['is_notice']) echo "table-primary"; ?>">
											...
											<?php if ($bo_table == "design_req") { ?>
												<td class="d-none d-md-table-cell"><?php echo $list[$i]['wr_9']; // 마감요청일 ?></td>
												<td class="d-none d-md-table-cell"><?php echo $list[$i]['wr_1']; // 마감요청일 ?></td>
												<td class="d-none d-md-table-cell"><?php echo $list[$i]['wr_2']; // 작업시작일 ?></td>
												<td class="d-none d-md-table-cell"><?php echo $list[$i]['wr_3']; // 작업마감일 ?></td>
												<td class="d-none d-md-table-cell"><?php echo $list[$i]['wr_4']; // 진행상태 ?></td>
											<?php } ?>
											<?php if($bo_table != "design_req") { ?>
								...
								<div class="d-flex justify-content-center mb-2 mb-sm-0">
									<?php if ($is_checkbox) { ?>
										<div class="btn-group xs-100">
											...
											<?php if ($admin_href && $member['mb_level'] == 10) { ?>
