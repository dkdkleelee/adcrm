				...
				<div class="col-12">
					...
					<div class="card card-danger">
						<div class="card-header">
							<h3 class="card-title"><?php echo '제목:'.cut_str(get_text($view['wr_subject']), 70) ?> &nbsp;&nbsp; <span class="badge badge-light">디자이너 <?php echo $view['wr_9'] ?></span> </h3> 
						</div>
						...
						<div class="d-flex flex-sm-row flex-column justify-content-sm-between m-3">
							<div class="d-flex justify-content-center mb-2 mb-sm-0">
								<?php if ($update_href || $delete_href || $copy_href || $move_href || $search_href) { ?>
									<div class="btn-group xs-100">
										...
										<?php if ($bo_table == "design_req" && $member['mb_deptno'] == "9") { ?> <a href="#" onclick="pick(<?php echo $view['wr_id'] ?>, '<?php echo $write_table ?>'); return false;" class="btn btn-danger"><i class="fa fa-check"></i> pick</a> <?php } ?>
									</div>
								<?php } ?>
							</div>
...
<script>
	...
	function pick(param, bo_table) { 
		
		var des_brd_no = param;
		var result = confirm("해당 디자인의 담당자로 지정하시겠습니까?");
		if(result){
            ...
            $.ajax({
				...
				data: {
					act : act
			       ,des_brd_no : des_brd_no
				   ,bo_table : bo_table
				},
				url: "<?php echo G5_BIZ_URL?>/design/design_ajax",
				dataType: "json",
