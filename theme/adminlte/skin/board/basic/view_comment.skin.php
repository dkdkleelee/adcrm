...
<div id="bo_vc_w" class="mb-4">
	...
	<div class="input-group mb-2">
		<textarea id="wr_content" name="wr_content" maxlength="10000" required class="form-control required m-3" rows="3" placeholder="댓글내용을 입력해주세요"><?php echo $c_wr_content; ?></textarea>
	</div>

	<div id="comment_info" class="row collapse m-3">
		<div class="col-md-6">
			<div class="input-group mb-2">
