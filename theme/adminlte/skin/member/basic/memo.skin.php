...
//add_stylesheet('<link rel="stylesheet" href="'.$member_skin_url.'/style.memo.css">', 1);
...
<link rel="stylesheet" href="<?php echo G5_THEME_URL; ?>/skin/member/basic/style.memo.css">
